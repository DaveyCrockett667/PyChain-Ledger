...
input_for_sender = st.text_input("Sender")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
input_for_receiver = st.text_input("Receiver")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
input_for_amount = st.text_input("Amount")
...
if st.button("Add Block"):
    ...
    # and `amount` values
    new_block = Block(
        record=Record(input_for_sender, input_for_receiver, input_for_amount),
        creator_id=42,
